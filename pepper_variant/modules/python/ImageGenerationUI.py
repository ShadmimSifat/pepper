    ...
    def convert_candidate_to_vcf_record(options, all_candidates):
        ...
        for candidate in all_candidates:
            ...
            if len(alt_alleles) > 0:
                ...
                positional_candidates[(candidate.contig, candidate.position)].append((candidate.contig, candidate.position, candidate.position + len(reference_allele), reference_allele, alt_alleles, [0, 1], candidate.depth, variant_allele_support))
        ...
        for candidates in positional_candidates.values():
            ...
            candidate_list.append((site_contig, site_ref_start, site_ref_end, site_ref_allele, site_alts, [0, 1], site_depth, site_supports))
